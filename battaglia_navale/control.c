...
void drawcross(int x,int y,int color){
    ...
    for(z=0;z<SPESSORECROCE;z++){
        gfx_line(x*SQUARE_SIZE+z+5,y*SQUARE_SIZE,x*SQUARE_SIZE+SQUARE_SIZE+5,y*SQUARE_SIZE+SQUARE_SIZE-z);
        gfx_line(x*SQUARE_SIZE+z+5,y*SQUARE_SIZE+SQUARE_SIZE,x*SQUARE_SIZE+SQUARE_SIZE+5,y*SQUARE_SIZE+z);
    }
    for(z=1;z<SPESSORECROCE;z++){
        gfx_line(x*SQUARE_SIZE+5,y*SQUARE_SIZE+z,x*SQUARE_SIZE+SQUARE_SIZE-z+5,y*SQUARE_SIZE+SQUARE_SIZE);
        gfx_line(x*SQUARE_SIZE+5,y*SQUARE_SIZE+SQUARE_SIZE-z,x*SQUARE_SIZE+SQUARE_SIZE-z+5,y*SQUARE_SIZE);
    }
}
